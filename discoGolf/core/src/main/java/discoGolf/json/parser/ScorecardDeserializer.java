...
public class ScorecardDeserializer extends JsonDeserializer<ScorecardDAO> {
   ...
   */
  @Override
  public ScorecardDAO deserialize(JsonParser p, DeserializationContext ctxt)
  ...
  /**
   * Deserialize a scorecard from a JSON node Makes it possible to use this. deserializer in other.
   * deserializers (DataArrayDeserializer).
   *
