...
/**
 * Keeps track of all scorecard objects in the database. The scorecard objects are stored in the
 * data ArrayList.
 *
...
public class Data {
  ...
  /**
   * Object for storing all the scorecards Its purpose is to be serialized and deserialized to and
   * from JSON.
   */
  public Data() {
