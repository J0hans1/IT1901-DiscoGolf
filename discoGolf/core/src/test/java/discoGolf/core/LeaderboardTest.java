...
public class LeaderboardTest {
  ...
  /**
   * Create create ScorecardDAO objects with two differents courses and add all of them to the Data
   * object
   */
  @BeforeEach
  public void setUp() {
    ...
    ArrayList<String> names = new ArrayList<>(
        Arrays.asList("Lars", "Ane", "Arne", "Maren", "Oskar", "Kari", "Karin", "Kai", "Nora"));
    ArrayList<Integer> totalScores =
        new ArrayList<>(Arrays.asList(13, 18, 18, 13, 23, 15, 15, 15, 23));
  ...
  public void testSetLeaderboard() {
    ...
    ArrayList<String> namesSorted = new ArrayList<>(
        Arrays.asList("Maren", "Lars", "Kai", "Karin", "Kari", "Ane", "Arne", "Nora", "Oskar"));
    ArrayList<Integer> totalScoresSorted =
        new ArrayList<>(Arrays.asList(13, 13, 15, 15, 15, 18, 18, 23, 23));
    ArrayList<Integer> bestHolesSorted =
        new ArrayList<>(Arrays.asList(-1, 1, 0, 0, 4, -1, -1, 2, 3));
  ...
  /**
   * Test getLeaderboardForCourse by checking that the list returned just contains scorecard objects
   * with the correct course name, and if the course name not excist it should return an empty
   * arrayList
   */
  @Test
  ...
  /**
   * Test that updateLeaderboard updates the relevant leaderboard correct, and if a scorecard with a
   * new course is added, a new leaderboard list should appear
   */
  @Test
  public void testUpdateLeaderboard() {
    ...
    assertTrue(leaderboard.getLeaderboardForCourse("NewCourse").stream()
        .allMatch(p -> p.getCourseName().equals("NewCourse")));
  }
}
