...
public class HoleTest {
  ...
  /**
   * Test constructor by setting par and test if the values are correct. Also, testing for invalid
   * input.
   */
  @Test
  ...
  /**
   * Test removeThrow() and addThrow() methods, should throw exception when holeThrows are 1 and you
   * try to remove throw
   */
  @Test
