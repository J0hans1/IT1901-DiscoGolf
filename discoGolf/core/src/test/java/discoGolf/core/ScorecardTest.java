...
public class ScorecardTest {
  ...
  /**
   * Test nextHole() and previousHole() methods in scorecard, test that you cannot go to previous
   * hole when hole number is 1 or course size
   */
  @Test
  ...
  /**
   * Test getBetsHoleScore which is should return the hole on the scorecard with best individual
   * score.
   */
  @Test
  ...
  /**
   * Test getTotalScore() method, and that the totalscore is correct after updating the scorecard
   * with throws
   */
  @Test
